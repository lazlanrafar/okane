  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown_root: cn(
          "relative border-input shadow-xs rounded-full border",
        ...
        day: cn(
          "relative w-full h-full p-0 text-center group/day aspect-square select-none [&:first-child_button[data-range-middle=true]]:rounded-l-full [&:last-child_button[data-range-middle=true]]:rounded-r-full",
