export const websiteEn = {
  ...
  integrations: {
    ...
    subtitle: "Connect your business tools in minutes.",
    available: "Available",
    comingSoon: "Coming Soon",
    telegram: {
      title: "Telegram",
      description: "Forward receipts via Telegram bot",
      setupTitle: "Setup Telegram Bot",
      setupSteps: [
        "Open Telegram and search for @OewangBot",
        "Start a chat and tap Connect",
